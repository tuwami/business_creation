...
#本番
#Apple
team = Team.create!(name: "OFFSIDE,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*1)
Team.create!(name: "OFFSIDE,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*2)
Team.create!(name: "OFFSIDE,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*3)
Team.create!(name: "OFFSIDE,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*4)

#Banana
(1..4).each do |num|
  Team.create!(name: "Ukiiii,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*num)
end
#Coconut
(1..4).each do |num|
  Team.create!(name: "WLH,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*num)
end
#Dragonfruit
(1..4).each do |num|
