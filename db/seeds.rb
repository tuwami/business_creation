...
#Banana
(1..4).each do |num|
  Team.create!(name: "Banana,Inc.", current_fund: 105, origin_fund: 105, investment_limit: 5*num)
end
#Coconut
(1..4).each do |num|
  Team.create!(name: "Coconut,Inc.", current_fund: 113, origin_fund: 113, investment_limit: 5*num)
end
# #Dragonfruit
# (1..4).each do |num|
