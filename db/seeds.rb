...
Team.create!(name: "team_a", origin_fund: 1100)
Team.create!(name: "team_b", origin_fund: 2100)
Team.create!(name: "team_c", origin_fund: 3100)
Team.create!(name: "team_d", origin_fund: 100)
Team.create!(name: "team_e", origin_fund: 5100)
Team.create!(name: "team_f", origin_fund: 6100)
Team.create!(name: "team_g", origin_fund: 100)
Team.create!(name: "team_h", origin_fund: 1100)
Team.create!(name: "team_i", origin_fund: 5100)
Team.create!(name: "team_j", origin_fund: 7100)
Team.create!(name: "team_k", origin_fund: 11100)
Team.create!(name: "team_l", origin_fund: 2100)
