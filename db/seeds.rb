...
#Apple
(1..4).each do |num|
  Team.create!(name: "YOSAKOI,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*num)
end
#Banana
(1..4).each do |num|
  Team.create!(name: "Riki Miyamoto,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*num)
end
#Coconut
(1..4).each do |num|
  Team.create!(name: "Rie Yamadaya,Inc.", current_fund: 100, origin_fund: 100, investment_limit: 5*num)
end
#Dragonfruit
(1..4).each do |num|
...
#Apple
User.create!(name: "user01", email: "waqoo01@waqoo.jp", password: "20200914")
User.create!(name: "user02", email: "waqoo02@waqoo.jp", password: "20200914")
User.create!(name: "user03", email: "waqoo03@waqoo.jp", password: "20200914")
User.create!(name: "user04", email: "waqoo04@waqoo.jp", password: "20200914")
User.create!(name: "user05", email: "waqoo05@waqoo.jp", password: "20200914")
#Banana                                                            20200914
User.create!(name: "user06", email: "waqoo06@waqoo.jp", password: "20200914")
User.create!(name: "user07", email: "waqoo07@waqoo.jp", password: "20200914")
User.create!(name: "user08", email: "waqoo08@waqoo.jp", password: "20200914")
User.create!(name: "user09", email: "waqoo09@waqoo.jp", password: "20200914")
User.create!(name: "user10", email: "waqoo10@waqoo.jp", password: "20200914")
#Cocnut                                                            20200914
User.create!(name: "user11", email: "waqoo11@waqoo.jp", password: "20200914")
User.create!(name: "user12", email: "waqoo12@waqoo.jp", password: "20200914")
User.create!(name: "user13", email: "waqoo13@waqoo.jp", password: "20200914")
User.create!(name: "user14", email: "waqoo14@waqoo.jp", password: "20200914")
User.create!(name: "user15", email: "waqoo15@waqoo.jp", password: "20200914")
#Dragonfruit                                                       20200914
User.create!(name: "user16", email: "waqoo16@waqoo.jp", password: "20200914")
User.create!(name: "user17", email: "waqoo17@waqoo.jp", password: "20200914")
User.create!(name: "user18", email: "waqoo18@waqoo.jp", password: "20200914")
User.create!(name: "user19", email: "waqoo19@waqoo.jp", password: "20200914")
User.create!(name: "user20", email: "waqoo20@waqoo.jp", password: "20200914")
#Elderberry                                                        20200914
User.create!(name: "user21", email: "waqoo21@waqoo.jp", password: "20200914")
User.create!(name: "user22", email: "waqoo22@waqoo.jp", password: "20200914")
User.create!(name: "user23", email: "waqoo23@waqoo.jp", password: "20200914")
User.create!(name: "user24", email: "waqoo24@waqoo.jp", password: "20200914")
User.create!(name: "user25", email: "waqoo25@waqoo.jp", password: "20200914")
