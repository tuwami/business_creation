...
User.create!(name: "user05", email: "waqoo12@waqoo.jp", password: "20200802")
#Banana                                                            20200802
User.create!(name: "user06", email: "waqoo05@waqoo.jp", password: "20200802")
User.create!(name: "user07", email: "waqoo06@waqoo.jp", password: "20200802")
User.create!(name: "user08", email: "waqoo07@waqoo.jp", password: "20200802")
User.create!(name: "user09", email: "waqoo08@waqoo.jp", password: "20200802")
User.create!(name: "user10", email: "waqoo12@waqoo.jp", password: "20200802")
#Cocnut                                                            20200802
User.create!(name: "user11", email: "waqoo09@waqoo.jp", password: "20200802")
User.create!(name: "user12", email: "waqoo10@waqoo.jp", password: "20200802")
User.create!(name: "user13", email: "waqoo11@waqoo.jp", password: "20200802")
User.create!(name: "user14", email: "waqoo12@waqoo.jp", password: "20200802")
User.create!(name: "user15", email: "waqoo12@waqoo.jp", password: "20200802")
